...
export default function DeletePanlet(Props:Props) {
  ...
  return (
    <div className=' w-full h-[700px]   fixed top-0   left-0  flex justify-center items-center text-center' style={Show?{background:"hsla(0, 0%, 0%, 0.7)"}:{display:"none"}}>
        <div className=' relative bg-white w-2/5 h-[260px]'>
            <h1 className=' text-black text-[36px] font-sans font-[400] p-9'>Вы уверены что хатите удалить этот обект</h1>
            <div className=' flex flex-row gap-8  justify-center mt-'>
               <button className='bg-grey text-black w-[200px] h-[50px] font-sans text-[24px]  font-[600]' onClick={()=>setShow(false)}>Cansel</button>
               <button className='bg-black text-white w-[200px] h-[50px] font-sans text-[24px]  font-[600]' onClick={OnSubmit}>Delete</button>
            </div>
